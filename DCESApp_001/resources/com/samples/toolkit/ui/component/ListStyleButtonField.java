...
public class ListStyleButtonField extends Field
{
    ...
    private static final int COLOR_BORDER = 0xeeeeee;
    private static final int COLOR_BACKGROUND_FOCUS = 0xdddddd;
...
//#endif
        ...
        if( _leftIcon != null ) {
            _leftOffset += _leftIcon.getWidth() + HPADDING + 20;
        }
        
        _rightOffset = HPADDING;
        if( _actionIcon != null ) {
            _rightOffset += _actionIcon.getWidth() + HPADDING + 20;
        }
