...
public class VerMapaT extends Estilos {
	...
	public VerMapaT(String latitudSt, String longitudSt,String local){
		...
		try{ 
			...
			ColorRichText emailCrt = new ColorRichText(local,0xffffff, RichTextField.FIELD_HCENTER | RichTextField.TEXT_ALIGN_HCENTER);
