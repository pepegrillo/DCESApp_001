...
public class FiltroCx {
	...
	public FiltroCx(String idCategoria){
		
		try{
			URI uri = URI.create(path.Path());
			Database sqliteDB = DatabaseFactory.open(uri);
			Statement se = sqliteDB.createStatement(statement.SelectMunicipio(idCategoria));
			se.prepare();
	...
	public void cargarDatos(String idcategoria){
		...
		try{
			...
			Statement selectR = sqliteDB.createStatement(statement.SelectMunicipio(idcategoria));
			selectR.prepare();
	...
	public void eliminarDatos(String idcategoria){
		...
		try{
        	URI uri1 = URI.create(path.Path());
			Database sqliteDB1 = DatabaseFactory.open(uri1);
			Statement dt = sqliteDB1.createStatement(statement.DeleteMunicipio(idcategoria));
